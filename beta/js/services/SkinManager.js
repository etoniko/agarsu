...
import { CELL_TEX_SIZE, CELL_TEX_RADIUS } from "../config/constants.js";
...
export class SkinManager {
    ...
    applyToCell(cell, name) {
        ...
        if (!cell.skinSprite) {
            ...
            s.anchor.set(0.5);
            s.width = CELL_TEX_SIZE + 2 * OVERSCAN;
            s.height = CELL_TEX_SIZE + 2 * OVERSCAN;
            s.zIndex = 2;
            s.roundPixels = false;
            ...
            mask.drawCircle(0, 0, CELL_TEX_RADIUS + OVERSCAN);
            mask.endFill();
            mask.zIndex = 3;
